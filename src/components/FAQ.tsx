...
export function FAQ({ activeFaq, setActiveFaq }: FAQProps) {
  return (
    <div className="relative bg-gradient-to-b from-white via-emerald-100 to-white py-24" id="faq">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-500">Everything you need to know about our cleaning services</p>
        </div>
